...
function Footer() {
  return (
    <div>
      <section className="">
        <footer className=" w-full px-4 lg:px-12 p-12  bg-black ">
          ...
          <div className="pt-7 flex flex-col min-[520px]:flex-row items-center justify-between gap-6">
            <ul className="flex items-center gap-9">
              <li>
                <a
                  href="/contact"
                  className="text-sm font-normal text-gray-300 transition-all duration-300 hover:text-indigo-600 focus-within:text-indigo-600 focus-within:outline-0"
                >
                  Contact
                </a>
              </li>
            ...
            <div className="flex items-center gap-4">
              <a
                href="javascript:;"
                className="border border-gray-300 p-2 rounded-full aspect-square text-gray-400 transition-all duration-500 hover:text-indigo-600 hover:border-indigo-600 focus-within:outline-0 focus-within:text-indigo-600 focus-within:border-indigo-600"
              >
                <svg
